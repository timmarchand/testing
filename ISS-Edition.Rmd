---
title: "Getting Started in R - ISS Edition"

# Use letters for affiliations
author:
  - name: Tim Marchand (original by Saghir Bashir)
  
affiliation: ISS, Gakushuun University


# Abstract
abstract: |
  This document provides a quick introduction to R for the ISS CLIL course. We will sometimes
  refer to it in class, and you can copy and paste some parts to include in your R Notes.
  It uses realistic examples and a real life dataset to manipulate, visualise and summarise data. 
  By the end of it you will have an overview of the key concepts of R and the "tidyverse" package. 
...
[^CWfup]: Saghir Bashir contacted the source authors and kindly received the following reply *"They were mainly undergraduate projects, final-year, rather than theses, so, unfortunately, it's unlikely that any record remains, particularly after so many years."*
